...
import { COMMON_CONSTANTS, FIELD_BOSS_COMMAND } from '../constants';
...
export default {
  data: new SlashCommandBuilder()
    .setName(FIELD_BOSS_COMMAND.COMMAND_NAME)
    .setDescription(FIELD_BOSS_COMMAND.COMMAND_DESCRIPTION)
    .addSubcommand((subcommand) =>
      subcommand
        .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.COMMAND_NAME)
        .setDescription(FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.COMMAND_DESCRIPTION)
        .addStringOption((option) =>
          option
            .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.OPTION_NAME)
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.TIME_SEARCH.COMMAND_NAME)
        .setDescription(FIELD_BOSS_COMMAND.SUB_COMMANDS.TIME_SEARCH.COMMAND_DESCRIPTION)
        .addStringOption((option) =>
          option
            .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.TIME_SEARCH.OPTION_NAME)
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.NAME_SEARCH.COMMAND_NAME)
        .setDescription(FIELD_BOSS_COMMAND.SUB_COMMANDS.NAME_SEARCH.COMMAND_DESCRIPTION)
        .addStringOption((option) =>
          option
            .setName(FIELD_BOSS_COMMAND.SUB_COMMANDS.NAME_SEARCH.OPTION_NAME)
  ...
  async execute(interaction) {
    ...
    if (subcommand === FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.COMMAND_NAME) {
      ...
      const query =
        `/${FIELD_BOSS_COMMAND.COMMAND_NAME} ${interaction.options.getSubcommand()} ` +
        `${FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.OPTION_NAME}:${interaction.options.getString(
          FIELD_BOSS_COMMAND.SUB_COMMANDS.INSTANT_SEARCH.OPTION_NAME,
        )}`;
      ...
      const query =
        `/${FIELD_BOSS_COMMAND.COMMAND_NAME} ${interaction.options.getSubcommand()} ` + `${FIELD_BOSS_COMMAND.SUB_COMMANDS.TIME_SEARCH.OPTION_NAME}:${time}`;
      ...
      const query =
        `/${FIELD_BOSS_COMMAND.COMMAND_NAME} ${interaction.options.getSubcommand()} ` + `${FIELD_BOSS_COMMAND.SUB_COMMANDS.NAME_SEARCH.OPTION_NAME}:${keyword}`;
