...
import insertLog, { Log } from './InsertLog.js';
...
export default {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName(TROPHY_COMMAND.CHARACTER_SEARCH.COMMAND_NAME)
        .setDescription(TROPHY_COMMAND.CHARACTER_SEARCH.COMMAND_DESCRIPTION)
        .addStringOption((option) =>
          option.setName(TROPHY_COMMAND.CHARACTER_SEARCH.OPTION_NAME).setDescription(TROPHY_COMMAND.CHARACTER_SEARCH.OPTION_DESCRIPTION).setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName(TROPHY_COMMAND.GUILD_SEARCH.COMMAND_NAME)
        .setDescription(TROPHY_COMMAND.GUILD_SEARCH.COMMAND_DESCRIPTION)
        .addStringOption((option) =>
          option.setName(TROPHY_COMMAND.GUILD_SEARCH.OPTION_NAME).setDescription(TROPHY_COMMAND.GUILD_SEARCH.OPTION_DESCRIPTION).setRequired(true),
        ),
    ),
...
const _sendCharacterContent = async (interaction) => {
  ...
  const embed = new MessageEmbed()
    ...
    .addFields(
      {
        name: TROPHY_COMMAND.CHARACTER_SEARCH.NICKNAME,
        value: character.nickname,
        inline: false,
      },
      {
        name: TROPHY_COMMAND.RANK,
        value: `${character.rank.toLocaleString()}${TROPHY_COMMAND.RANK_UNIT}`,
        inline: true,
      },
      {
        name: TROPHY_COMMAND.TROPHY,
        value: `${character.trophy.toLocaleString()}${TROPHY_COMMAND.TROPHY_UNIT}`,
        inline: true,
      },
    )
...
const _sendGuildContent = async (interaction) => {
  ...
  const embed = new MessageEmbed()
    ...
    .addFields(
      {
        name: TROPHY_COMMAND.GUILD_SEARCH.GUILD_NAME,
        value: guild.guildName,
        inline: false,
      },
      {
        name: TROPHY_COMMAND.RANK,
        value: `${guild.rank.toLocaleString()}${TROPHY_COMMAND.RANK_UNIT}`,
        inline: true,
      },
      {
        name: TROPHY_COMMAND.TROPHY,
        value: `${guild.trophy.toLocaleString()}${TROPHY_COMMAND.TROPHY_UNIT}`,
        inline: true,
      },
      {
        name: TROPHY_COMMAND.GUILD_SEARCH.GUILD_MASTER,
        value: guild.master,
        inline: true,
      },
    )
...
const _downloadProfileImage = (url, filename) => {
  ...
  return new Promise(async (resolve, reject) => {
    request(requestData, () => {
      resolve(new MessageAttachment().setFile(`${process.env.FILE_PATH}/${filename}.jpg`).setName(`profile.jpg`));
